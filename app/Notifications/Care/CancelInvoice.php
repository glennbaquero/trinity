...
class CancelInvoice extends Notification
{
    use Queueable;
    ...
    public function __construct(Request $request, $invoice)
    {
        ...
        $this->message = "We're sorry to hear that your order #" .$this->invoice->invoice_number. " has been ". $this->request->type ." .";
    }
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->subject(config('app.name') . ': Order Cancelled')
