...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.admin-users.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                       <admin-users-view
                       fetch-url="{{ route('admin.admin-users.fetch-item', $item->id) }}"
                       submit-url="{{ route('admin.admin-users.update', $item->id) }}"
