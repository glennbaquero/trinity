...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.vouchers.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <vouchers-view
                        fetch-url="{{ route('admin.vouchers.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.vouchers.update', $item->id) }}"
                        ></vouchers-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        ref="table-1"
                        :auto-fetch="false"
                        fetch-url="{{ route('admin.activity-logs.fetch.vouchers', $item->id) }}"
                        ></activity-logs-table>
                    </div>
                </div>
            </div>
