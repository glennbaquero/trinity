...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="mb-4">
            <a href="{{ route('admin.bank-details.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <bank-details-table 
                            ref="table-1"
                            fetch-url="{{ route('admin.bank-details.fetch') }}"
                            ></bank-details-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            :auto-fetch="false"
                            fetch-url="{{ route('admin.bank-details.fetch-archive') }}"
                            ></bank-details-table>
                        </div>
                    </div>
                </div>
