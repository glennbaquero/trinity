...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Rewards</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        <div class="mb-4">
            <a href="{{ route('admin.rewards.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            :auto-fetch="false"
                            fetch-url="{{ route('admin.rewards.fetch-archive') }}"
                            ></rewards-table>
                        </div>
                    </div>
                </div>
