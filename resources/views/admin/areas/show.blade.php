...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.areas.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <area-view
                        fetch-url="{{ route('admin.areas.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.areas.update', $item->id) }}"
                        ></area-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        ref="table-1"
                        :auto-fetch="false"
                        fetch-url="{{ route('admin.activity-logs.fetch.areas', $item->id) }}"
                        ></activity-logs-table>
                    </div>
                </div>
            </div>
