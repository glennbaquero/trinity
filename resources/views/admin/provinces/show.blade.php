...
@section('pageTitle', 'Update Province')
...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.provinces.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <provinces-view
                        fetch-url="{{ route('admin.provinces.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.provinces.update', $item->id) }}"
                        ></provinces-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        ref="table-1"
                        :auto-fetch="false"
                        fetch-url="{{ route('admin.activity-logs.fetch.provinces', $item->id) }}"
                        ></activity-logs-table>
                    </div>
                </div>
            </div>
